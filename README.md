...
1. Download the Flurry Unity package from [flurry-sdk-3.2.0.unitypackage](https://github.com/flurry/unity-flurry-sdk/raw/master/flurry-sdk-3.2.0.unitypackage), or [flurry-sdk-3.2.0-push.unitypackage](https://github.com/flurry/unity-flurry-sdk/raw/master/flurry-sdk-3.2.0-push.unitypackage) if you want to use Flurry Push.
   - If you are using Apple Xcode 12, please use releases [flurry-sdk-3.2.0-xcode12.unitypackage](https://github.com/flurry/unity-flurry-sdk/raw/master/flurry-sdk-3.2.0-xcode12.unitypackage), or [flurry-sdk-3.2.0-xcode12-push.unitypackage](https://github.com/flurry/unity-flurry-sdk/raw/master/flurry-sdk-3.2.0-xcode12-push.unitypackage).
