...
- Download and install from [Github](https://github.com/flurry/unity-flurry-sdk)
  ...
  1. Download the Flurry Unity package from [flurry-sdk-5.0.0.unitypackage](https://github.com/flurry/unity-flurry-sdk/raw/master/flurry-sdk-5.0.0.unitypackage).
